...
describe('device ACL policy', () => {
  it('stores exactly two constrained allows followed by deny-all for the username', async () => {
    ...
    expect(policy).toEqual({ username: 'device-68E274BD2A58', rules: expectedRules })
  ...
  it.each([
    ...
    [
      'overbroad_acl_rule',
      [{ ...expectedRules[0], topic: 'products/pc-mini/devices/68E274BD2A58/#' }, expectedRules[1], expectedRules[2]],
    ],
  ...
  it('defines the complete positive and negative probe matrix', () => {
    expect(buildAclProbeMatrix(canonical)).toEqual([
      ...
      },
      {
        ...
        operation: 'publish',
        topic: 'products/pc-mini/devices/68E274BD2A58/events/battery',
        qos: 1,
        retained: false,
        expected: 'denied',
      },
      ...
      },
      {
        ...
        operation: 'publish',
        topic: 'devices/68E274BD2A58/events/urination',
        qos: 1,
        retained: false,
        expected: 'denied',
      },
      {
        ...
        operation: 'publish',
        topic: 'products/pc-mini/devices/68E274BD2A58/commands/restart',
        qos: 1,
        retained: false,
        expected: 'denied',
      },
      {
        ...
        operation: 'subscribe',
        topic: 'products/pc-mini/devices/68E274BD2A58/commands/#',
        qos: 1,
        expected: 'denied',
      },
      {
