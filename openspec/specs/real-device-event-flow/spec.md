# real-device-event-flow Specification

## Purpose

Define the frozen-environment, cross-system correlation, exact side-effect, access-control, evidence-sanitization, cleanup, and failure guarantees for verifying physical device events end to end.
