...
Provide members with a bounded, cursor-paginated view of a selected device's urination event history, with stable ordering, device-scoped state, explicit loading/empty/error states, data validation, stale response isolation, and Asia/Taipei time display.
...
<!-- @trace
source: browse-device-event-history
updated: 2026-07-29
code:
