# device-claim-onboarding Specification

## Purpose

Define the protected Web, Member API, broker-ingress, persistence, recovery, and security requirements for first-owner device Claim onboarding.
