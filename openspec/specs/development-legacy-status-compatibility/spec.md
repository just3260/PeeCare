# development-legacy-status-compatibility Specification

## Purpose

Define the development-only paired EMQX compatibility routes that translate one legacy Arduino status into canonical Urination and Battery event shapes, together with their payload boundaries, sanitized observation semantics, and reversible lifecycle.
